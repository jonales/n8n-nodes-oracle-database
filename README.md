...
> **Version 1.3.0** — Official n8n build system (`@n8n/node-cli`), full thin/thick mode support per credential.
...
> **Versão 1.3.0** — Build oficial n8n (`@n8n/node-cli`), suporte completo thin/thick mode por credencial.
